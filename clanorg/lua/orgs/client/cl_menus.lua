...
net.Receive("orgmenu", function()
	...
	membersBlockLabel:SetText("Участники:")
	...
	onlineMembersBlockLabel:SetText("Онлайн:")
	...
	orgBalanceBlockLabel:SetText("Баланс:")
			...
			playerOptions.DoClick = function()
				...
				if table.HasValue(data[2], "e") then
					memberOptions:AddOption("Kick Member", function() 
						Derma_Query("Вы действительно хотите выгнать ".. name .." из "..ORGS_Config.addonName.."?", "Внимание!",
